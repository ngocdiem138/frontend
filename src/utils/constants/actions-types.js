...
export const FETCH_SAVEJOB_SUCCESS = "FETCH_SAVEJOB_SUCCESS";
export const FETCH_ALL_JOBPOST_SUCCESS = "FETCH_ALL_JOBPOST_SUCCESS";
export const LOADING_SAVEJOB = "LOADING_SAVEJOB";
export const PERFUME_ADDED_TO_SAVEJOB_SUCCESS = "PERFUME_ADDED_TO_SAVEJOB_SUCCESS";
export const PERFUME_REMOVED_FROM_SAVEJOB_SUCCESS = "PERFUME_REMOVED_FROM_SAVEJOB_SUCCESS";
...
export const FETCH_ALL_COMPANYS_SUCCESS = "FETCH_ALL_COMPANYS_SUCCESS";
